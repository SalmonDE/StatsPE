...
class StatsPE extends PluginBase implements Listener{
	...
	public function onEnable(){
		...
		if($provider == 'JSON'){
			...
			$this->getLogger()->info(TF::GREEN.'Establishing connection to MySQL Server: '.$this->getConfig()->get('address').':'.$this->getConfig()->get('port'));
			$connection = mysqli_connect($this->getConfig()->get('address'), $this->getConfig()->get('user'), $this->getConfig()->get('password'), $this->getConfig()->get('database'), $this->getConfig()->get('port'));
                        if(mysqli_connect_error() == NULL){
                            $this->getLogger()->info(TF::GREEN.'Successful connected to MySQL Server!');
                        }else{
                            $this->getLogger()->critical(TF::RED.'Could not successfully connect to the MySQL Server! Info:');
                            $this->getLogger()->info(TF::GOLD.mysqli_connect_error());
                        }
		}else{
